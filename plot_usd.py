"""Grafica equity USD + DD%. Uso: py plot_usd.py"""
...
DATA = BASE / "data"
CAP0 = 1000.0
T = pd.read_csv(DATA / "trades_usd.csv")
...
a1.set_title("XAUUSD 2025 FluxoV2 - 1000 USD riesgo 0.5pc a 1444.92 (+44.5pc) DD 8.5pc")
a1.set_ylabel("USD")
